...
$VERSION_SUBSTITUION = "main.version=5.0.0"
$GO_MIN_VERSION_SUBSTITUTION = "github.com/ram-nad/go-monorepo/go-ci-tool/v5/constants.minGoVersion=$GO_MIN_VERSION"
$GOLANG_CI_LINT_VERSION_SUBSTITUTION = "github.com/ram-nad/go-monorepo/go-ci-tool/v5/constants.minGolangCILintVersion=$GOLANGCI_LINT_VERSION"
